...
PageShp TabPrinter::build_kinematics_page()
{
    ...
    optgroup->append_single_option_line("resonance_avoidance_mode", "printer_motion_ability#resonance-avoidance");
...
void TabPrinter::toggle_options()
{
    ...
    if (m_active_page->title() == L("Motion ability")) {
        ...
        toggle_option("resonance_avoidance_mode", resonance_avoidance);
